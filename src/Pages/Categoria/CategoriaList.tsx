...
export const CategoriaList = () => {
    ...
    return (
        <>
            ...
            <Table data={category} columns={columns} dbColumns={dbcolumns} title='Categoría de Insumos' createLink='create' createText='Crear Categoría' label='Buscar Categoría' 
            deleteFunction={handleDelete} tituloDocumento={'Categorías de insumo'} nombreArchivo={'CaInsumos'}/>
        </>
    )
}
